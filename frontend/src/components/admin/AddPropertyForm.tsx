...
function PropertyMapSection({ 
  ...
  const handleMapSearchChange = async (e: any) => {
  ...
  return (
    <div className="mt-6">
      ...
      <div className="bg-gray-50 p-2 rounded-lg mb-2 text-sm text-gray-600 space-y-2">
        <p>Search for a place or address and select a suggestion to update the map location, or click directly on the map to fine-tune the coordinates.</p>
